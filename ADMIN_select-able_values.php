<html>
<head>
    <title>A: Selectable Values Table</title>
    ...
    <script type="text/javascript">
        function buildGrid(options) {
            ...
            $("#grid").jqGrid({
                url: "libs/select-able_values_DataLoader.php",
                editurl: "libs/select-able_values_DataEditor.php",
                datatype: 'json',
                mtype: 'POST',
                colNames: ['ID', 'TABLE NAME', 'TABLE VARIABLE'],
                colModel: [
                    generateColModel({type: 'number', name: 'id', index: 'id'}),
                    generateColModel({type: 'string', name: 'table_name', index: 'table_name'}),
                    generateColModel({type: 'string', name: 'table_var_name', index: 'table_var_name'}),
                ],
                rowNum:10,
                rowList:[10,15,20],
                pager: '#jqGridPager',
