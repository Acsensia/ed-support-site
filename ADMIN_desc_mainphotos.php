...
<head>
    ...
    <script type="text/javascript">
        function buildGrid(options) {
            ...
            console.log(innerArrayScan(allValuesForSelects, 'pages'));

            $("#grid").jqGrid({
                url: "libs/desc_mainphotos_DataLoader.php",
                editurl: "libs/desc_mainphotos_DataEditor.php",
                datatype: 'json',
                mtype: 'POST',
                colNames: ['ID', 'PAGE ID', 'IMAGE'],
                colModel: [
                    ...
                    generateColModel({type: 'string', name: 'image', index: 'image'}),
                ],
                rowNum:10,
                rowList:[10,15,20],
                pager: '#jqGridPager',
